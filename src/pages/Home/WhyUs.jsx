...
const WhyUs = () => {
  const features = [
    ...
    {
      icon: <FiSearch className="text-2xl text-indigo-600" />,
      title: "Powerful Search",
      description:
        "Find exactly what you're looking for with our advanced filtering and search capabilities.",
    },
    {
      icon: <FiStar className="text-2xl text-indigo-600" />,
      title: "Rating System",
      description:
      ...
      <div className="flex flex-col lg:flex-row gap-12 items-center">
        ...
        >
          <div className="relative">
            ...
            <motion.div
              className="absolute -bottom-4 -left-4 bg-white p-3 rounded-lg shadow-md z-10"
            ...
            <motion.div
              className="absolute -top-4 -right-4 bg-white p-3 rounded-lg shadow-md z-10"
              initial={{ scale: 0.8, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
