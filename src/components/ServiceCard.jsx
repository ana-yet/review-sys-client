...
const ServiceCard = ({ service }) => {
  ...
  return (
    <motion.div
      className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-md group"
      whileHover={{ y: -5 }}
    ...
    >
      ...
      <div className="p-5">
        <div className="flex justify-between items-start">
          ...
          <span className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white text-xs font-semibold px-2.5 py-1 rounded-full whitespace-nowrap shadow-sm">
            ${service.price}
          </span>
        </div>
